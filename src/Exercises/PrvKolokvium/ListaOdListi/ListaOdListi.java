package Exercises.PrvKolokvium.ListaOdListi;
...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        //Vashiot kod tuka...
        long product = 1;
        DLLNode<DLL<Integer>> iterator = list.getFirst ();
        while(iterator != null){
            DLL<Integer> SubList = iterator.element;
            DLLNode<Integer> iterator2 = SubList.getFirst ();
            int sum = 0;
            while(iterator2 != null){
                sum += iterator2.element;
